 ...
 * output format.
 */
class MP4Muxer private constructor (rotation: Int): Muxer {

    private lateinit var mediaMuxer: MediaMuxer


    @RequiresApi(Build.VERSION_CODES.O)
    constructor(fileDescriptor: FileDescriptor, rotation: Int): this(rotation) {
        mediaMuxer = MediaMuxer(fileDescriptor, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4).also {
            it.setOrientationHint(rotation)
        }

    }

    constructor(path: String, rotation: Int) : this(rotation) {
